class ShaderProgram {
    ...
    static compile(gl) {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            if (i === 0) {
                console.log(`Light ${i} uniform locations:`, posLoc !== null ? 'OK' : 'NULL', colLoc !== null ? 'OK' : 'NULL');
            }
        }

        console.log('Shader program compiled successfully with', lightPositions.length, 'light slots');
