class Renderer {
    constructor(gl) {
        ...
        this.lights = [
            { position: new Vector3(23.4, 2.5, -5.8), color: new Vector3(1.0, 0.9, 0.8) },  // Monitor 1
            { position: new Vector3(23.1, 2.5, -3.7), color: new Vector3(0.8, 0.9, 1.0) },  // Monitor 2
            { position: new Vector3(23.6, 2.5, -7.8), color: new Vector3(0.9, 1.0, 0.9) }   // Monitor 3
        ];
    ...
    renderScene(camera) {
        ...
        gl.uniform1i(program.uniformLocations.numLights, this.lights.length);
        
        if (this.renderCount === 0) {
            console.log('Passing', this.lights.length, 'lights to shader');
            console.log('Light positions:', this.lights.map(l => `(${l.position.x.toFixed(1)}, ${l.position.y.toFixed(1)}, ${l.position.z.toFixed(1)})`));
        }
