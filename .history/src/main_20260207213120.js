class Application {
    ...
    async loadOBJModels() {
        ...
        // Cadeira verde na frente da mesa com três monitores
        try {
            ...
            if (cadeiraGeometry.materials) {
                console.log('Cadeira materials loaded:', cadeiraGeometry.materials.size);
                OBJLoader.applyMaterialColors(cadeiraGeometry, cadeiraGeometry.materials);
            }
            
            // Posiciona a cadeira na frente da mesa (X=25, Z=-5.8)
            // Rotacionada 180° (Math.PI) para ficar virada para a mesa
            const cadeira = this.renderer.addObject(
                cadeiraGeometry,
                new Vector3(25, 0, -5.8),
                new Vector3(0, Math.PI, 0),
                new Vector3(1, 1, 1)
            );
            this.objModels.push(cadeira);
            console.log('Cadeira verde posicionada na frente da mesa');
        } catch (error) {
