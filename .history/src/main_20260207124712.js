class Application {
    ...
    async setupScene() {
        ...
        // Monitor / quadro com textura em cima da mesa
        const screenTexture = await this.renderer.loadTexture('./assets/textures/2548700.jpg');
        const monitorScreen = this.renderer.addObject(
            cubeGeometry,
            new Vector3(22, 1.7, -0.3),  // em cima da mesa, encostado na "parede"
            new Vector3(0, 0, 0),
            new Vector3(1.2, 0.7, 0.05), // tela fina
            screenTexture
        );
