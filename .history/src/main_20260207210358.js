class Application {
    ...
    async loadOBJModels() {
        ...
        try {
            ...
            // New chair is centered at origin with height Y=0 to 2.8
            // Mesa is at X=22.5 to 24.5, Z=-9 to -2.6
            // Monitors are at X≈23, Z: -5.8, -3.7, -7.8
            // Place chairs at X=21 (in front of mesa), aligned with monitor Z positions
            const chairPositions = [
                { x: 21, z: -5.8 },  // Chair for monitor 1
                { x: 21, z: -3.7 },  // Chair for monitor 2
                { x: 21, z: -7.8 }   // Chair for monitor 3
            ];
            ...
            for (const pos of chairPositions) {
                const chair = this.renderer.addObject(
                    ...
                    new Vector3(0, -Math.PI / 2, 0),  // Rotate to face the table/monitors
                    new Vector3(1, 1, 1)
                );
