class Application {
    ...
    async loadOBJModels() {
        ...
        try {
            ...
            // Chair dimensions: X(0-1), Y(0-2.5), Z(0-1)
            // Chair center is at X=0.5, Y=1.25, Z=0.5
            ...
            for (const pos of chairPositions) {
                // Offset from chair's local center (X=0.5, Y=1.25, Z=0.5)
                const chair = this.renderer.addObject(
                    chairGeometry,
                    new Vector3(pos.x - 0.5, -1.25, pos.z - 0.5),
                    new Vector3(0, 0, 0),
                    new Vector3(1, 1, 1)
                );
