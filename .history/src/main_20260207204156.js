    ...
    async loadOBJModels() {
        ...
        try {
            ...
            if (buildingGeometry.materials) {
                ...
                // Check if "Materiais" material (used by quadro) has texture
                const quadroMaterial = buildingGeometry.materials.get('Materiais');
                if (quadroMaterial && quadroMaterial.map_Kd) {
                    console.log(`Quadro material has texture: ${quadroMaterial.map_Kd}`);
                    try {
                        ...
                        buildingTexture = await this.renderer.loadTexture(textureUrl);
